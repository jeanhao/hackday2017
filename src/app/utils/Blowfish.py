...
class EasyBlowfish():
    ...
    def encrypt(self,text):
        self.cipher.initCTR()  
        return xx_b64encode(self.cipher.encryptCTR(text))
    
    def decrypt(self,text):
        self.cipher.initCTR()  
        return self.cipher.decryptCTR(xx_b64decode(text))
    
    def is_match(self,text,htext):
        self.cipher.initCTR()
        return text == self.decrypt(htext) 

##############################################################
# Module testing
 
if __name__ == '__main__':
    eb = EasyBlowfish.instance()
    t = eb.encrypt('asdqwewqewq')
    print t 
    print eb.decrypt(t)
