...
AUTH_BASE_URL = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + APPID + "&redirect_uri=http%3A%2F%2Fwww.baidu.com%2Flogin&response_type=code&scope=snsapi_userinfo&state=public/"
# hustbbm
